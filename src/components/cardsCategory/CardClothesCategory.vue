<template>
    <v-container>
      ...
      >
        ...
        <v-img height="350" src="\src\assets\img\buso.jpg" cover></v-img>
  
        <v-card-item>
          <v-card-title>Camibuso</v-card-title>
          <v-card-title>$ 34.900</v-card-title>
        </v-card-item>
  
        <!-- Nueva sección de selección de colores -->
        ...
        <v-card-actions>
          <v-btn class="custom-btn" block border>
            Agregar al carrito
          </v-btn>
        </v-card-actions>
      </v-card>
  ...
  <style scoped>
  .custom-card {
    box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.2); /* Más sombra */
  }
  
  .custom-btn {
    background-color: #FAB400 !important; /* Color de fondo del botón */
